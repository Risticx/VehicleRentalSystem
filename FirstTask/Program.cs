...
Rental rental = rentalService.CreateRental(vehicle, "John Doe", DateTime.Now.AddDays(-10), DateTime.Now);
...
rental = rentalService.CreateRental(vehicle, "Mary Johnson", DateTime.Now.AddDays(-10), DateTime.Now);
//rental.ReturnDate = DateTime.Now;
rentalService.CalculateTotalCost(rental);
...
rental = rentalService.CreateRental(vehicle, "John Markson", DateTime.Now.AddDays(-10), DateTime.Now.AddDays(5));
rental.ReturnDate = DateTime.Now;
rentalService.CalculateTotalCost(rental);